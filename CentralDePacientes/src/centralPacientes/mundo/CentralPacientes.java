...
public class CentralPacientes {
    ...
    public int cantHombres() {
        // Se declara la variable numHmbres en 0;
        int numHombres = 0;
        // Se hace un bucle para recorrer todos los pacientes encontrados;
        for (Paciente paciente : darPacientes())
            // Cada vez que se cumple la condici�n (paciente == Hombre), aumenta numHombres.
            if (paciente.darSexo() == Paciente.HOMBRE) numHombres++;
        // Retorna la cantidad encontrada para Paciente.HOMBRE total.
        return numHombres;
    }
    ...
    public int cantMujeres() {
        // Se declara la variable numMujeres en 0;
        int numMujeres = 0;
        // Se hace un bucle para recorrer todos los pacientes encontrados;
        for (Paciente paciente : darPacientes())
            // Cada vez que se cumple la condici�n (paciente == MUJER), aumenta numMujeres.
            if (paciente.darSexo() == Paciente.MUJER) numMujeres++;
        // Retorna la cantidad encontrada para Paciente.MUJER total.
        return numMujeres;
    }
